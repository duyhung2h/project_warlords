    ...
    **Methods**
    ...
    def _id_map() -> dict:
        ...
        **Private Method**
        ...
        """
        return {'id': 0, 'icon_id': 1, 'dead_id': 2, 'hotkey_id': 3, 'gaia_only': 4, 'garrison_cap': 5}
    ...
    def GARRISON_CAP(self) -> int:
        """
        Returns:
            A garrison_cap value
        """
        return self._get_property('garrison_cap')
    ...
    @classmethod
    def garrison_cap(cls, garrison_cap: int) -> InfoDatasetBase:
        return cls._from_id('garrison_cap', garrison_cap)
